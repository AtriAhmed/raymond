...
export default function calculateRemainingLeaveDays(workLogs:any[], holidays:any[], leaveRequests:any[], weekRestDays:any[], startDate:any, endDate:any, yearLeaveDays:number) {
    ...
    const absentTime = supposedWorkTime - totalWorkTime;
    const absentDays = Math.trunc(absentTime / 1000 / 60 / 60 / 8);
  
    return yearLeaveDays - absentDays - nbLeaveDays;
  }